...
class FlaskMixin:
    ...
    def _make_oidc_login(
        ...
        request = FlaskRequest(request_data=login_data, cookies={}, session={}, request_is_secure=secure)
        ...
        with patch("flask.redirect") as mock_redirect:
            ...
            with patch.object(FlaskOIDCLogin, "_get_uuid", autospec=True) as get_uuid, patch.object(
                ...
                if enable_check_cookies:
                    ...
                    self.assertTrue(
                        'document.addEventListener("DOMContentLoaded", checkCookiesAllowed);' in response_html
                    )
